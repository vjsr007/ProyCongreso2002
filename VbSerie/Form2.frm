...
Dim cad As String
 ...
 While j < 31
   ...
   If error1 = False Then
     Text1(sensor).Text = Int((dato / 1023) * 100)
     Shape1(sensor).Height = Int(dato / 1023) / 500 * 2000
